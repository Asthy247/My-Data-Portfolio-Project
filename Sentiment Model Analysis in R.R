...
# Creating word cloud to visualize the most frequent words in the positive and negative reviews:
...
# Save the model using RDS.
> saveRDS(optimized_rf, file = "C:\\Users\\aonigb01\\Downloads\\Data Science\\Python\\Data Science Projects with Python\\Temu Sentiment Analysis - Model.RData")
> saveRDS(dtm, file = "C:\\Users\\aonigb01\\Downloads\\Data Science\\Python\\Data Science Projects with Python\\Temu Sentiment Analysis - DTM.RData")
> saveRDS(train_dtm, file = "C:\\Users\\aonigb01\\Downloads\\Data Science\\Python\\Data Science Projects with Python\\Temu Sentiment Analysis - train_dtm.RData")
